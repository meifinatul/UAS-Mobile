...
const featuredDishes = [
  {
    ...
    description: 'Pizza enak dengan harga terjangkau',
    harga:'Rp 35,000',
    beli:'Beli Sekarang',
  },
  {
    ...
    description: 'Jus ini terbuat dari buah jeruk asli',
    harga:'Rp 10,000',
    beli:'Beli Sekarang',
  },
  {
    ...
    description: 'sushi gulung bergaya maki yang menggunakan alpukat, mentimun, dan daging kepiting sebagai pengganti ikan mentah tradisional.',
    harga:'Rp 45,000',
    beli:'Beli Sekarang',
  },
  {
    ...
    description: 'Seblak enak harga terjangkau',
    harga:'Rp 15.000',
    beli:'Beli Sekarang',
  },
  {
    ...
    description: 'Burger lezat dengan topping yang melimpah',
    harga:'Rp 20,000',
    beli:'Beli Sekarang',
  },
];
